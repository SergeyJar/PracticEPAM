        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewHtml = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_AspNetUsers_IdUserNavigationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LikesWithDislikes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LikesWithDislikes_AspNetUsers_IdUserNavigationId",
                        column: x => x.IdUserNavigationId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_LikesWithDislikes_Product",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LikesWithDislikes_IdProduct",
                table: "LikesWithDislikes",
                column: "IdProduct");

            migrationBuilder.CreateIndex(
                name: "IX_LikesWithDislikes_IdUserNavigationId",
                table: "LikesWithDislikes",
                column: "IdUserNavigationId");

            migrationBuilder.CreateIndex(
                name: "IX_Product_IdCategories",
                table: "Product",
                column: "IdCategories");

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_IdUserNavigationId",
                table: "Reviews",
                column: "IdUserNavigationId");
        }
